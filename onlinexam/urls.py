...
urlpatterns = [
    ...
    path('admin-add-subject', views.admin_add_subject_view, name='admin-add-subject'),
    path('admin-view-subject', views.admin_view_subject_view, name='admin-view-subject'),
    path('delete-subject/<int:pk>', views.delete_subject_view, name='delete-subject'),
    ...
    # Proctoring
    path('admin-proctoring', views.admin_proctoring_view, name='admin-proctoring'),
